...
class TitleWindow(QWidget, Ui_Form):
    ...
    def my_Qss(self):
        ...
        # Qss美化
        qssStyle = '''
                   QWidget[other_name='title_bar_widget']{border-image:url(background2.png);
                   ...
                   font-family:"Webdings";
                   text-align:top;
                   background:#6DDF6D;border-radius:8px;
                   border:none;
                   font-size:10px;
                   }
                   ...
                   {
                   font-family:"Webdings";
                   background:#F7D674;border-radius:8px;
                   border:none;
                   font-size:10px;
                   }
                   ...
                   {
                   font-family:"Webdings";
                   background:#F76677;border-radius:8px;
                   border:none;
                   font-size:10px;
                   }
